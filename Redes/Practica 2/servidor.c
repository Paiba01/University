                        ...
                        if(i==sd){
                            ...
                            if(recibidos > 0){
                                ...
                                /************************************************************************************************/
                                    ...
                                    char* nombre = buffer + posicionNombre; // Creamos el nombre y al coger lo otro se guarda "NOMBRE+(-p)..." y con strtok quitamos el espacio
                                    nombre = strtok(nombre," ");
                                    char* password = buffer + posicionPassword;
                                    password[strlen(password)-1]='\0'; // Aquí es igual que en el nombre pero no hay mas cosas detras
